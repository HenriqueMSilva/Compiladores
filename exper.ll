...
%n = alloca i32
store i32 %.n, i32* %n
%.1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.0, i32 0, i32 0))
ret void
}
define void @method_overload_1() {
%.1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i32 0, i32 0))
ret void
}
...
%.3 = add i32 0, 0
%.4 = icmp sgt i32 %.2, %.3
br i1 %.4, label %then3, label %else3
then3:
%.5 = add i32 0, 0
%.6 = load i8**, i8*** %args
%.7 = add i32 1 , %.5 
